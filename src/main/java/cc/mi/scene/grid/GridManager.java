...
public final class GridManager {
	public static final GridUpdateMask gridUpdateMask = new GridUpdateMask(
			SceneElementEnumFields.ELEMENT_INT_FIELDS_SIZE, SceneElementEnumFields.ELEMENT_STR_FIELDS_SIZE);
	...
	// /*
	// stringstream os;
	// for (auto ti = m_wo_need_refresh_grid.begin(); ti !=
	// m_wo_need_refresh_grid.end(); ++ ti) {
